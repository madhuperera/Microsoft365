...
.EXAMPLE
    .\ReportMemberMFAV2.ps1 -InactiveDays 90

.EXAMPLE
    .\ReportMemberMFAV2.ps1 -InactiveDays 30 -Test
#>
...
if (-not $OutputPath) {
    ...
    $OutputPath = Join-Path (Get-Location).Path "ReportMemberMFAV2_$S_Timestamp.csv"
}
...
$S_AuthStrengthRows
    ...
    <div class="footer">
        CSV data: $(Split-Path $OutputPath -Leaf) | Report generated by ReportMemberMFAV2.ps1
    </div>
</body>
</html>
"@
...
<body>
    ...
    <div class="footer">
        Summary view &middot; full report: $(Split-Path $S_HtmlPath -Leaf) &middot; generated by ReportMemberMFAV2.ps1
    </div>
</body>
</html>
"@
