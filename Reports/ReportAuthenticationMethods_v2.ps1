...
# Guard it so the CSV export below always runs on macOS and Linux.
...
{
    Write-Host "Out-GridView is not available on this platform; skipping grid view (the CSV export still runs)." -ForegroundColor Yellow
}
